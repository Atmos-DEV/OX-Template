:menu
@echo off & color 0f & cls & title Novalia V2
mode 60,20
color 09
echo.
...
echo.
cd /d C:\Users\LuniD\Desktop\OXTemplate
C:\Users\LuniD\Desktop\OXTemplate\artifact\FXServer.exe +exec server.cfg
...
XCOPY C:\Users\LuniD\Desktop\OXTemplate C:\Users\LuniD\Desktop\OXTemplate\backup /m /e /y 
rem Changez les 2 chemins d'accès ci-dessus
echo.
...
RMDIR /s /q "C:\Users\LuniD\Desktop\OXTemplate\artifact\cache"
